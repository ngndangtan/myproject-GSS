 ...
 */
static __inline uint16_t mavlink_msg_param_set_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_param_set_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_param_set_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_param_set_t* param_set)
{
...
static __inline void mavlink_msg_param_set_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, const char *param_id, float param_value, uint8_t param_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[23];
	_mav_put_float(buf, 0, param_value);
 ...
 * @return System ID
 */
static __inline uint8_t mavlink_msg_param_set_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static __inline uint8_t mavlink_msg_param_set_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_param_set_get_param_id(const mavlink_message_t* msg, char *param_id)
{
 ...
 */
static __inline float mavlink_msg_param_set_get_param_value(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_param_set_get_param_type(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_param_set_decode(const mavlink_message_t* msg, mavlink_param_set_t* param_set)
{
